      ...
      <div className="user_internal_transfer_main_container">
        <div className="user_internal_transfer_card">
          ...
          <div className="user_internal_transfer_para">
            <p>
              You are about to request an internal transfer from one of your
              accounts to the other. Please note that you can transfer funds
              between your own accounts only. If you transfer funds to the
              account in a different currency, we will convert these funds to
              the current market quote. Please enter the transfer amount and
              select the destination account. Then enter your JETTRADE FX PIN
              and submit the request. Internal transfers usually take 1–2 hours
              to be processed.
            </p>
          </div>
              ...
              <div className="internal_transfer_pin_area col-sm">
                <div className="internal_transfer_pin_part col-sm">
                  <div className="internal_transfer_pin">
                    <label htmlFor="jettrade_pin" class="form-label">
                      JETTRADE FX PIN
                    </label>
                    <PinInput
                      length={4}
                  ...
                  <div className="forget_internal_transfer_pin">
                    <NavLink to="/userdashboard/setting/resetpassword">
                      Forget your jettrade fx pin
                    </NavLink>
                  </div>
                </div>
