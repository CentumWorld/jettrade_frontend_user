...
function NewDeposite() {
  const accounts = ["Select Amount", "1", "2", "3"];
  ...
  const amountFunction = (e) => {
    ...
    setEathValue(
      (Math.round(e.target.value * onetEthValue * 100) / 100).toFixed(2)
    );
        ...
        <div className="new-deposit_card">
          ...
          <div className="where_to_money_transfer row">
            <span className="col-md-6">
              <select
                className="where_to_money_transfer_select"
                id="selectAmount"
              >
          ...
          <div className="deposite_coin_account_type ">
            <div
              className="deposite_coin_card"
              onClick={() => changeDiv("btc")}
            >
              <span>
            ...
            <div
              className="deposite_coin_card"
              onClick={() => changeDiv("usdtt")}
            >
              <span>
                <img src={usdtt} alt="" width="80px" height="40px" />
              </span>
            ...
            >
              <span>
                <img src={bnb_image} alt="" width="80px" height="40px" />
              </span>
            ...
            >
              <span>
                <img src={bank_transfer} alt="" width="80px" height="40px" />
              </span>
          ...
          <div className="deposit_commission_area">
            <ul>
              ...
              <li>
                ...
                <small> BEST EXCHANGE RATES</small>
              </li>
              <li>
                <span>
                  <MdOutlineVerifiedUser />
                </span>{" "}
                <small>50% DEPOSIT BONUS</small>
              </li>
            </ul>
          </div>
          <div className="choose_bonus">
            ...
            <div
              className={
                bonusArea ? "choose_bonus_area_large" : "choose_bonus_area"
              }
            >
              <div className="bonus_point_area" onClick={bonusareacard}>
                  <p>What advantages does the bonus bring?</p>
                  <BsChevronDown  style={{marginRight:"1rem",}}/>
              </div>
              {bonusArea ? (
                <div className="bonus_advantage">
                  <ul>
                    <li>
                      {" "}
                      <img src={bonus1} height="40px" alt="" /> Provides higher
                      trading volume
                    </li>
                    <li>
                      {" "}
                      <img src={bonus2} height="40px" alt="" /> Does not block
                      withdrawals
                    </li>
                    <li>
                      {" "}
                      <img src={bonus3} height="40px" alt="" /> Can be converted
                      to your money in full by trading <br />{" "}
                      <small>No time limits on completing the bonus</small>
                    </li>
                    <li>
                      {" "}
                      <img src={bonus4} height="40px" alt="" /> Can be cancelled
                      at your will at any moment
                    </li>
                  </ul>
                </div>
              ) : (
          ...
          {changeDivState === "btc" ? (
            <div className="bit-coin-card">
              ...
              <div className="bit-coin-para">
                ...
                <p>
                  {" "}
                  <strong>We only accept Bitcoin (BTC)</strong> Bitcoin (BTC) is
                  a stand-alone payment instrument and is not associated with
                  Bitcoin Cash or any other cryptocurrency fork.
                </p>
              </div>
              <div className="bit-coin-para-two">
                ...
                <p>
                  The total of all your Bitcoin deposits cannot exceed
                  $20,000.00 a day.
                </p>
              </div>
              <hr />
              <div className="proceed_with_bitcoin_button">
                <button className="choose_another_method_btc btn btn-secondary">
                  CHOOSE ANOTHER METHOD
                </button>
                <button className="proceed_with_bitcoin">
                  PROCEED WITH BTC
                </button>
              </div>
            </div>
          ...
          {changeDivState === "doge" ? (
            <div className="bit-coin-card">
              ...
              <div className="bit-coin-para">
                ...
                <p>
                  {" "}
                  <strong>The minimum deposit amount is 230 Ð.</strong> All
                  deposits below the limit will be lost.
                </p>
              </div>
              <div className="bit-coin-para-two">
                <span>
              ...
              <div className="proceed_with_bitcoin_button">
                ...
                <button className="proceed_with_bitcoin btn btn-primary">
                  PROCEED WITH DOGE
                </button>
              </div>
            </div>
          ...
          {changeDivState === "ethereum" ? (
            <div className="ethereum-coin-card">
              ...
              <div className="ethereum_coin_currency">
                <span>
                  <img src={eth_currency} height="20px" alt="" />
                </span>
                <span>ETH</span>
              </div>
          ...
          {changeDivState === "litecoin" ? (
            <div className="bit-coin-card">
              ...
              <div className="bit-coin-para">
                ...
                <p>
                  {" "}
                  <strong>The minimum deposit amount is 0.3 Ł</strong> All
                  deposits below the limit will be lost.
                </p>
              </div>
              <div className="bit-coin-para-two">
          ...
          {changeDivState === "usdte" ? (
            <div className="bit-coin-card">
              ...
              <div className="bit-coin-para">
                ...
                <p>
                  {" "}
                  <strong>The minimum deposit amount is 50 ₮.</strong> All
                  deposits below the limit will be lost.
                </p>
              </div>
              <div className="bit-coin-para-two">
