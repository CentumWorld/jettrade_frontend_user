          ...
          <div className="demo_accont_three_div">
            <div className="demo_metatrade_five">
              <div className="demo_metatrade_five_heading">
                <p>
                  MetaTrader <strong style={{ color: "orange" }}>5</strong>
                </p>
              </div>
              <div className="demo_meta_trade_content">
                <p>
                  Spread from..................0.6 pips <br />
                  <small>Floating spread markup</small>
                </p>
                <p>
                  Min Deposite..................$25 <br />
                  <small>Favourable:$100</small>
                </p>
                <p>
                  Instruments <br />
                  <small>230 instruments</small>
                </p>
              </div>
            </div>
            <div className="demo_metatrade_four">
              <div className="demo_metatrade_five_heading">
                <p>
                  MetaTrader <strong style={{ color: "orange" }}>4</strong>
                </p>
              </div>
              <div className="demo_meta_trade_content">
                <p>
            ...
            <div className="demo_metatrade_jet">
              ...
              <div className="demo_meta_trade_content">
                <p>
                  Trade in a new way <br />
                  <small>
                    Access the world's financial markets with our brand-new
                    trading platform
                  </small>
                </p>
                <p>
                  Inhance your experience <br />
                  <small>
                    Enjoy all trading tools and analytics in one place
                  </small>
                </p>
              </div>
            </div>
