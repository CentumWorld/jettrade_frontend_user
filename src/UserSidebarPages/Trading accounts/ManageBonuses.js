      ...
      <div className="bonuses_main_container">
        <div className="bonuses_card">
          ...
          <div className="bonuses_para">
            <p>
              Our goal is to make your trading experience convenient and
              outstanding. Deposit your account, and we will add from 10% to 50%
              to its amount for free. It is a perfect way to increase your
              account's total funds.
            </p>
          </div>
            ...
            <Box sx={{ width: "100%", typography: "body1" }}>
              <TabContext value={value}>
                <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                  ...
                  >
                    <Tab
                      style={{ fontWeight: "800", fontSize: "16px",fontFamily:'Roboto' }}
                      label="AVAILABLE DEPOSIT BONUSES"
                      value="1"
                    />
                    <Tab
                      style={{ fontWeight: "800", fontSize: "16px",fontFamily:'Roboto' }}
                      label="ACTIVE AND CANCELLED BONUSES"
                      value="2"
                    />
                  </TabList>
                </Box>
                <TabPanel value="1">
                  <div className="deposit_bonuses">
                    <div className="deposit_bonus_data">
                      <p>
                        This is a list of all your available deposit bonuses.
                        Click Get bonus to claim one.
                      </p>
                    </div>
                ...
                <TabPanel value="2">
                  <div className="active_canceled_bonuses">
                    <div className="active_canceled_bonus_para">
                      <p>
                        This is a list of all your received and cancelled
                        deposit bonuses. Here you can cancel your bonus.
                      </p>
                    </div>
                    <div className="active_canceled_bonus_para_second">
                      <p>
                        Please note that we update the bonus statistics once an
                        hour. A bonus amount will be added to your account
                        balance and will become withdrawable automatically
                        within 1–2 hours after you trade the required volume.
                      </p>
                    </div>
